...
async def button(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if action == "desc":
        await q.message.reply_text(
            ...
            parse_mode="Markdown", reply_markup=back_keyboard(code)
        )
    elif action == "quotes":
        await q.message.reply_text(
